...
from proovid_python_sdk.model.sum_sub_verification_response_list_base_response import SumSubVerificationResponseListBaseResponse as SumSubVerificationResponseListBaseResponseSchema
...
from proovid_python_sdk.type.sum_sub_verification_response_list_base_response import SumSubVerificationResponseListBaseResponse

from ...api_client import Dictionary
from proovid_python_sdk.pydantic.base_response import BaseResponse as BaseResponsePydantic
from proovid_python_sdk.pydantic.sum_sub_verification_response_list_base_response import SumSubVerificationResponseListBaseResponse as SumSubVerificationResponseListBaseResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SumSubVerificationResponseListBaseResponseSchema
SchemaFor200ResponseBodyTextJson = SumSubVerificationResponseListBaseResponseSchema
SchemaFor200ResponseBodyTextPlain = SumSubVerificationResponseListBaseResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SumSubVerificationResponseListBaseResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_verifications_mapped_args(
        self,
    ...
    async def _aget_verifications_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/NaturalPerson/{naturalPersonId}/verifications',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetVerificationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_verifications(
        self,
        natural_person_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_verifications_mapped_args(
            natural_person_id=natural_person_id,
        )
        return await self._aget_verifications_oapg(
    ...
    def get_verifications(
        ...
        return self._get_verifications_oapg(
            path_params=args.path,
        )

class GetVerifications(BaseApi):
    ...
    async def aget_verifications(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SumSubVerificationResponseListBaseResponsePydantic:
        raw_response = await self.raw.aget_verifications(
            natural_person_id=natural_person_id,
            **kwargs,
        )
        if validate:
            return SumSubVerificationResponseListBaseResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SumSubVerificationResponseListBaseResponsePydantic, raw_response.body)
    ...
    def get_verifications(
        ...
        raw_response = self.raw.get_verifications(
            natural_person_id=natural_person_id,
        )
        if validate:
            return SumSubVerificationResponseListBaseResponsePydantic(**raw_response.body)
