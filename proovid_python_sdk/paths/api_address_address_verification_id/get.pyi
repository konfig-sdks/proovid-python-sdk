...
class VerifyByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def averify_by_id(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._verify_by_id_mapped_args(
            id=id,
        )
        return await self._averify_by_id_oapg(
    ...
    def verify_by_id(
        ...
        return self._verify_by_id_oapg(
            path_params=args.path,
        )

class VerifyById(BaseApi):
    ...
    async def averify_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.averify_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def verify_by_id(
        ...
        raw_response = self.raw.verify_by_id(
            id=id,
        )
        if validate:
            return AddressVerificationResultPydantic(**raw_response.body)
