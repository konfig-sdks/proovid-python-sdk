...
class SumSubVerificationResponseListBaseResponse(BaseModel):
    ...
    data: typing.Optional[typing.Optional[typing.List[SumSubVerificationResponse]]] = Field(None, alias='data')
