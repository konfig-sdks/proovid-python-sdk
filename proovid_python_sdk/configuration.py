...
from proovid_python_sdk.exceptions_base import ApiValueError
from proovid_python_sdk.exceptions import ClientConfigurationError
...
conf = proovid_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://proovidapi.azurewebsites.net" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if bearer:
            self.api_key['Bearer'] = bearer
        else:
            raise ClientConfigurationError('API Key "Bearer" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("proovid_python_sdk")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://proovidapi.azurewebsites.net",
