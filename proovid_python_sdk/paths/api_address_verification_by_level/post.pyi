...
from proovid_python_sdk.model.address_request import AddressRequest as AddressRequestSchema
...
from proovid_python_sdk.type.address_request import AddressRequest
from proovid_python_sdk.type.address_verification_result import AddressVerificationResult

from ...api_client import Dictionary
from proovid_python_sdk.pydantic.address_request import AddressRequest as AddressRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AddressRequestSchema
SchemaForRequestBodyTextJson = AddressRequestSchema
SchemaForRequestBodyApplicationJsonPatchjson = AddressRequestSchema
SchemaForRequestBodyApplicationJson = AddressRequestSchema


request_body_address_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _verify_by_level_mapped_args(
        self,
        reference_id: typing.Optional[typing.Optional[str]] = None,
        email: typing.Optional[typing.Optional[str]] = None,
        natural_person_id: typing.Optional[typing.Optional[int]] = None,
        natural_person_index_id: typing.Optional[typing.Optional[int]] = None,
        name: typing.Optional[typing.Optional[str]] = None,
        surname: typing.Optional[typing.Optional[str]] = None,
        ...
        skip_document_comparison: typing.Optional[bool] = None,
        validity_period: typing.Optional[int] = None,
        ...
        if verification_level is not None:
            _body["verificationLevel"] = verification_level
        ...
        if skip_document_comparison is not None:
            _body["skipDocumentComparison"] = skip_document_comparison
        if validity_period is not None:
            _body["validityPeriod"] = validity_period
        args.body = _body
        return args

    async def _averify_by_level_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/Address/VerificationByLevel',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_address_request.serialize(body, content_type)
...
class VerifyByLevelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def averify_by_level(
        self,
        reference_id: typing.Optional[typing.Optional[str]] = None,
        email: typing.Optional[typing.Optional[str]] = None,
        natural_person_id: typing.Optional[typing.Optional[int]] = None,
        ...
        **kwargs,
        ...
        args = self._verify_by_level_mapped_args(
            ...
            skip_document_comparison=skip_document_comparison,
            validity_period=validity_period,
        )
        return await self._averify_by_level_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def verify_by_level(
        ...
        return self._verify_by_level_oapg(
            body=args.body,
        )

class VerifyByLevel(BaseApi):
    ...
    async def averify_by_level(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.averify_by_level(
            reference_id=reference_id,
            email=email,
            natural_person_id=natural_person_id,
            natural_person_index_id=natural_person_index_id,
    ...
    def verify_by_level(
        ...
        raw_response = self.raw.verify_by_level(
            reference_id=reference_id,
            email=email,
            natural_person_id=natural_person_id,
            natural_person_index_id=natural_person_index_id,
