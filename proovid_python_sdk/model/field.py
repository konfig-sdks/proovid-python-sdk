...
class Field(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["value", "source", "tag", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["value", "source", "tag", ], str]):
