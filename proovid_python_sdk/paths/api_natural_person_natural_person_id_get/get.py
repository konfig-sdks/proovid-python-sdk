...
from proovid_python_sdk.model.natural_person_response_base_response import NaturalPersonResponseBaseResponse as NaturalPersonResponseBaseResponseSchema

from proovid_python_sdk.type.base_response import BaseResponse
from proovid_python_sdk.type.natural_person_response_base_response import NaturalPersonResponseBaseResponse

from ...api_client import Dictionary
from proovid_python_sdk.pydantic.base_response import BaseResponse as BaseResponsePydantic
from proovid_python_sdk.pydantic.natural_person_response_base_response import NaturalPersonResponseBaseResponse as NaturalPersonResponseBaseResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = NaturalPersonResponseBaseResponseSchema
SchemaFor200ResponseBodyTextJson = NaturalPersonResponseBaseResponseSchema
SchemaFor200ResponseBodyTextPlain = NaturalPersonResponseBaseResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: NaturalPersonResponseBaseResponse
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/NaturalPerson/{naturalPersonId}/get',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NaturalPersonResponseBaseResponsePydantic:
        raw_response = await self.raw.aget_details(
            natural_person_id=natural_person_id,
            **kwargs,
        )
        if validate:
            return NaturalPersonResponseBaseResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NaturalPersonResponseBaseResponsePydantic, raw_response.body)
