...
class UpdateNaturalPersonDocumentsDataSaveResult(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idDocumentSaved", "faceSaved", "livenessCheckURL", "addressDocumentSaved", "verificationStarted", "allSucceeded", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idDocumentSaved", "faceSaved", "livenessCheckURL", "addressDocumentSaved", "verificationStarted", "allSucceeded", ], str]):
