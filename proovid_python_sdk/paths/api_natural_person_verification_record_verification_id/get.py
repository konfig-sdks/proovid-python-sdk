...
# Path params
VerificationIdSchema = schemas.Int64Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'verificationId': typing.Union[VerificationIdSchema, decimal.Decimal, int, ],
    }
)
...
class BaseApi(api_client.Api):
    ...
    def _get_verification_record_mapped_args(
        self,
        verification_id: int,
    ...
    async def _aget_verification_record_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/NaturalPerson/verificationRecord/{verificationId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_verification_record_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetVerificationRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_verification_record(
        self,
        verification_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_verification_record_mapped_args(
            verification_id=verification_id,
        )
        return await self._aget_verification_record_oapg(
    ...
    def get_verification_record(
        ...
        return self._get_verification_record_oapg(
            path_params=args.path,
        )

class GetVerificationRecord(BaseApi):
    ...
    async def aget_verification_record(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_verification_record(
            verification_id=verification_id,
            **kwargs,
        )
        if validate:
    ...
    def get_verification_record(
        ...
        raw_response = self.raw.get_verification_record(
            verification_id=verification_id,
        )
        if validate:
            return NaturalPersonInfoResponseBaseResponsePydantic(**raw_response.body)
