...
class NaturalPersonDocumentRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["country", "document", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["country", "document", ], str]):
