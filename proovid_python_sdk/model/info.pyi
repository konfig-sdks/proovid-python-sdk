...
class Info(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["agent", "geolocation", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["agent"]) -> typing.Union['Agent', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["agent", "geolocation", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        agent: typing.Union['Agent', schemas.Unset] = schemas.unset,
