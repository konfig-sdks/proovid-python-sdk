...
class BaseApi(api_client.Api):
    ...
    def _update_documents_mapped_args(
        self,
    ...
    async def _aupdate_documents_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/NaturalPerson/{naturalPersonId}/updateDocuments',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateDocumentsRaw(BaseApi):
    ...
    async def aupdate_documents(
        ...
        **kwargs,
        ...
        args = self._update_documents_mapped_args(
            natural_person_id=natural_person_id,
            id_document=id_document,
            address_document=address_document,
        )
        return await self._aupdate_documents_oapg(
            body=args.body,
    ...
    def update_documents(
        ...
        return self._update_documents_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateDocuments(BaseApi):
    ...
    async def aupdate_documents(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_documents(
            natural_person_id=natural_person_id,
            id_document=id_document,
            address_document=address_document,
            **kwargs,
    ...
    def update_documents(
        ...
        raw_response = self.raw.update_documents(
            natural_person_id=natural_person_id,
            id_document=id_document,
            address_document=address_document,
        )
