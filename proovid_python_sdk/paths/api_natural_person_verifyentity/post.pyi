...
class BaseApi(api_client.Api):
    ...
    def _verify_entity_mapped_args(
        self,
    ...
    async def _averify_entity_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/NaturalPerson/verifyentity',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class VerifyEntityRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def averify_entity(
        self,
        info: typing.Optional[AddNaturalPersonInfoRequest] = None,
        client_reference_id: typing.Optional[typing.Optional[str]] = None,
        documents: typing.Optional[NaturalPersonDocumentsRequest] = None,
        **kwargs,
        ...
        args = self._verify_entity_mapped_args(
            info=info,
            client_reference_id=client_reference_id,
            documents=documents,
        )
        return await self._averify_entity_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def verify_entity(
        ...
        return self._verify_entity_oapg(
            body=args.body,
        )

class VerifyEntity(BaseApi):
    ...
    async def averify_entity(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.averify_entity(
            info=info,
            client_reference_id=client_reference_id,
            documents=documents,
            **kwargs,
    ...
    def verify_entity(
        ...
        raw_response = self.raw.verify_entity(
            info=info,
            client_reference_id=client_reference_id,
            documents=documents,
        )
