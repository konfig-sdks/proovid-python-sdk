...
class BaseApi(api_client.Api):
    ...
    def _verify_details_mapped_args(
        self,
    ...
    async def _averify_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/NaturalPerson/verify',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class VerifyDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def averify_details(
        self,
        info: typing.Optional[AddNaturalPersonInfoRequest] = None,
        client_reference_id: typing.Optional[typing.Optional[str]] = None,
        documents: typing.Optional[NaturalPersonDocumentsRequest] = None,
        **kwargs,
        ...
        args = self._verify_details_mapped_args(
            info=info,
            client_reference_id=client_reference_id,
            documents=documents,
        )
        return await self._averify_details_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def verify_details(
        ...
        return self._verify_details_oapg(
            body=args.body,
        )

class VerifyDetails(BaseApi):
    ...
    async def averify_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.averify_details(
            info=info,
            client_reference_id=client_reference_id,
            documents=documents,
            **kwargs,
    ...
    def verify_details(
        ...
        raw_response = self.raw.verify_details(
            info=info,
            client_reference_id=client_reference_id,
            documents=documents,
        )
