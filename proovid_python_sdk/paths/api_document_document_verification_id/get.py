...
class BaseApi(api_client.Api):
    ...
    def _verify_status_mapped_args(
        self,
        id: int,
    ...
    async def _averify_status_oapg(
        self,
...
class VerifyStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def averify_status(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._verify_status_mapped_args(
            id=id,
        )
        return await self._averify_status_oapg(
    ...
    def verify_status(
        ...
        return self._verify_status_oapg(
            path_params=args.path,
        )

class VerifyStatus(BaseApi):
    ...
    async def averify_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.averify_status(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def verify_status(
        ...
        raw_response = self.raw.verify_status(
            id=id,
        )
        if validate:
            return DocumentVerificationResponsePydantic(**raw_response.body)
