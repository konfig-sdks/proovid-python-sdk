...
from proovid_python_sdk.pydantic.sum_sub_aml_verification_hit_response import SumSubAmlVerificationHitResponse
from proovid_python_sdk.pydantic.sum_sub_aml_verification_response_categories import SumSubAmlVerificationResponseCategories

class SumSubAmlVerificationResponse(BaseModel):
    status: typing.Optional[EStatus] = Field(None, alias='status')

    categories: typing.Optional[SumSubAmlVerificationResponseCategories] = Field(None, alias='categories')
    ...
    hits: typing.Optional[typing.Optional[typing.List[SumSubAmlVerificationHitResponse]]] = Field(None, alias='hits')
