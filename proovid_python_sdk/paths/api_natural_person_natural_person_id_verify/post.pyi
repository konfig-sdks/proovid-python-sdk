...
from proovid_python_sdk.model.sum_sub_verification_response_base_response import SumSubVerificationResponseBaseResponse as SumSubVerificationResponseBaseResponseSchema

from proovid_python_sdk.type.base_response import BaseResponse
from proovid_python_sdk.type.sum_sub_verification_response_base_response import SumSubVerificationResponseBaseResponse

from ...api_client import Dictionary
from proovid_python_sdk.pydantic.base_response import BaseResponse as BaseResponsePydantic
from proovid_python_sdk.pydantic.sum_sub_verification_response_base_response import SumSubVerificationResponseBaseResponse as SumSubVerificationResponseBaseResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SumSubVerificationResponseBaseResponseSchema
SchemaFor200ResponseBodyTextJson = SumSubVerificationResponseBaseResponseSchema
SchemaFor200ResponseBodyTextPlain = SumSubVerificationResponseBaseResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SumSubVerificationResponseBaseResponse
...
class BaseApi(api_client.Api):
    ...
    def _verify_details_0_mapped_args(
        self,
    ...
    async def _averify_details_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/NaturalPerson/{naturalPersonId}/verify',
            auth_settings=_auth,
            headers=_headers,
        )
...
class VerifyDetails0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def averify_details_0(
        self,
        natural_person_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._verify_details_0_mapped_args(
            natural_person_id=natural_person_id,
        )
        return await self._averify_details_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def verify_details_0(
        self,
        natural_person_id: int,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._verify_details_0_oapg(
            path_params=args.path,
        )

class VerifyDetails0(BaseApi):
    ...
    async def averify_details_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SumSubVerificationResponseBaseResponsePydantic:
        raw_response = await self.raw.averify_details_0(
            natural_person_id=natural_person_id,
            **kwargs,
        )
        if validate:
            return SumSubVerificationResponseBaseResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SumSubVerificationResponseBaseResponsePydantic, raw_response.body)
    ...
    def verify_details_0(
        ...
        raw_response = self.raw.verify_details_0(
            natural_person_id=natural_person_id,
        )
        if validate:
            return SumSubVerificationResponseBaseResponsePydantic(**raw_response.body)
