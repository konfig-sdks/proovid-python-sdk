...
class RequiredNaturalPersonEconomicProfileResponse(TypedDict):
    pass

class OptionalNaturalPersonEconomicProfileResponse(TypedDict, total=False):
    ...
    industryNameOfHighestRisk: typing.Optional[str]
...
class NaturalPersonEconomicProfileResponse(RequiredNaturalPersonEconomicProfileResponse, OptionalNaturalPersonEconomicProfileResponse):
    pass
